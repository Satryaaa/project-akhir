        ...
        <div class="max-w-screen-md mx-auto flex justify-center">
                ...
                <div class="w-2/5  max-[480px]:w-full px-2">
                    <div class="flex flex-col flex-wrap">
                        <form action="/processEditFoto/{{$data->id}}" method="post" enctype="multipart/form-data">
                            @csrf
                        <h3>Judul</h3>
                        <input type="text" name="judul_foto" id="" class="py-1 rounded-full border-slate-500" value="{{$data->judul_foto}}">
                        <h3 class="mt-4">Deskripsi</h3>
                        <input type="text" name="deskripsi_foto" id="" class="py-1 rounded-full border-slate-500" value="{{$data->deskripsi_foto}}">
                        ...
                        <div class="flex flex-row justify-between"> --}}
                            <div></div>
                            <button type="submit" class="px-6 py-1 mt-4 text-white rounded-md bg-blue-500">Save</button>
                        </form>
                        </div>
